...
namespace Unplugged.IbmBits
{
    public static class BinaryReaderExtensionMethods
    {
        ...
        //Может можно заменить на метод из базовой библиотеки?
        public static float ReadSignedByteToSingle(this BinaryReader reader)
        {
            /*
        ...
        public static float ReadBigEndian32ToSingle(this BinaryReader reader)
        {
            return (float)reader.ReadInt32BigEndian();
        }
        public static float ReadInt32ToSingle(this BinaryReader reader)
        {
            return (float)reader.ReadInt32();
        }

        public static float ReadBigEndian16ToSingle(this BinaryReader reader)
        {
            return reader.ReadInt16BigEndian();
        }

        public static float ReadInt16ToSingle(this BinaryReader reader)
        {
